...
## Fork scope amendment (2026-09-16)

The device's explicit terminal colors remain absolute, as recorded in ADR 0002's fork
amendment. Setting either color opts out of Muse's native light-theme surface and foreground
overrides, just as it opts out of inversion for other agents. With both colors empty, Muse
uses the native rendering above. Explicit ANSI colors remain authoritative on custom surfaces.
