...
/** The connection surface describes both requests that back an active pane, not just the herd
 * snapshot. A pane-only network or auth failure must therefore join the root loader's flags. */
export function shownConnectionFlags(home: HomeData, pane: PaneData | undefined) {
  return {
