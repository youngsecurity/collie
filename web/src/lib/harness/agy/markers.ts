...
// would stall.
//
// Match "tell Claude" only in its numbered "No, and tell Claude" permission option, not in
// ordinary conversation or an AGY option mentioning Claude. It is the only Claude name on a permission screen whose welcome
