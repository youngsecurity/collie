...
export const es: Dictionary = {
  ...
  "settings.updateCard.peer.state.unknown": "en curso",
  ...
  "updateScreen.startUnreported": "No está disponible el progreso de la actualización que iniciaste. Revisa su registro antes de volver a intentarlo.",
