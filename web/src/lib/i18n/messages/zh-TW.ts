...
export const zhTW: Dictionary = {
  ...
  "settings.fonts.colors": "顏色",
  "settings.fonts.colors.hint":
    "目前裝置上終端機鏡像的預設文字顏色與背景色。代理自身設定的顏色仍然優先；設定了顏色的鏡像在淺色主題下不會反相。",
  "settings.fonts.colors.foreground": "文字顏色",
  "settings.fonts.colors.background": "背景顏色",
  "settings.fonts.colors.matrix": "Matrix",
  "settings.fonts.colors.matrix.hint": "MesloLGS NF，黑底綠字。",
  "settings.fonts.colors.reset": "重設",
  ...
  "updateScreen.startUnreported": "無法取得你啟動的更新進度。重試前請檢查更新日誌。",
