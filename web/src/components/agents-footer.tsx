...
import type { MirrorSurface } from "@/hooks/use-display-prefs";
...
export function AgentsFooter({ rows, face }: { rows: StyledLine[]; face: MirrorSurface }) {
  ...
  return (
    <div
      className={cn(
        ...
        // Match the status strip: custom colors are absolute and never inverted (ADR 0002).
        MIRROR_SPACE,
        face.colors === undefined && MIRROR_INVERT,
        face.className,
      )}
      style={face.style}
    >
