...
import { RawMirrorAppearanceContext, type RawMirrorAppearance } from "@/components/raw-mirror";
...
export interface CardDockProps extends RawMirrorAppearance {
...
export function CardDock(props: CardDockProps) {
  const appearance = useMemo(
    () => ({ colors: props.colors, nativeMirror: props.nativeMirror }),
    [props.colors, props.nativeMirror],
  );
  ...
  return (
    ...
    >
      <RawMirrorAppearanceContext value={appearance}>{card}</RawMirrorAppearanceContext>
    </div>
  );
}
